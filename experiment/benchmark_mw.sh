...
do 
    CUDA_VISIBLE_DEVICES=$1 accelerate launch $2 --env_name $task --n_exps 25 --ckpt_dir "../ckpts/metaworld" --milestone 24 --result_root "results_AVDC_mw"
done

python org_results_mw.py --results_root "results_AVDC_mw" 