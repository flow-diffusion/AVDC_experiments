...
ALL_V1_ENVIRONMENTS_GOAL_HIDDEN = create_hidden_goal_envs(ALL_V1_ENVIRONMENTS)
ALL_V1_ENVIRONMENTS_GOAL_OBSERVABLE = create_observable_goal_envs(ALL_V1_ENVIRONMENTS)
